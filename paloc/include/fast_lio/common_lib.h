...
#include <fast_lio/fast_lio/Pose6D.h>
...
#define DEBUG_FILE_DIR(name)     (string(string(ROOT_DIR) + name))
//#define DEBUG_FILE_DIR(file, name)     (string(string(file) + "Log/"+ name))
